        ...
        <table class="table table-hover">
            ...
            <tbody class="">
                ...
                <?php foreach($books as $book):  ?>
                    ...
                    <td id="button">
                    <a href="/books/detailisbn/<?= $book['isbn']; ?>" class="btn btn-primary rounded-circle d-flex justify-content-center align-items-center p-0" style="width:32px;height:32px;"><i class="fas fa-info"></i></a>
                    <a href="/books/editisbn/<?= $book['isbn']; ?>" class="btn btn-warning rounded-circle d-flex justify-content-center align-items-center p-0" style="width:32px;height:32px;"><i class="fas fa-edit"></i></a>
                    </td>
                    </tr>
                <?php $i ++; ?>
                <?php endforeach; ?>
