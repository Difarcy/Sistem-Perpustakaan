        ...
        <table class="table table-hover">
            ...
            <tbody class="">
                ...
                <?php foreach($peminjaman as $pinjam):  ?>
                    ...
                    <td id="button">
                    <a href="/peminjaman/detail/<?= $pinjam['id_peminjaman']; ?>" class="btn btn-primary rounded-circle d-flex justify-content-center align-items-center p-0" style="width:32px;height:32px;"><i class="fas fa-info"></i></a>
                    <a href="/peminjaman/delete/<?= $pinjam['id_peminjaman']; ?>" class="btn btn-danger rounded-circle d-flex justify-content-center align-items-center p-0 tombol-hapus" style="width:32px;height:32px;"><i class="fas fa-trash"></i></a>
                    <a href="/peminjaman/pengembalian/<?= $pinjam['id_peminjaman']; ?>" class="btn btn-success rounded-circle d-flex justify-content-center align-items-center p-0" style="width:32px;height:32px;"><i class="fas fa-check"></i></a>
